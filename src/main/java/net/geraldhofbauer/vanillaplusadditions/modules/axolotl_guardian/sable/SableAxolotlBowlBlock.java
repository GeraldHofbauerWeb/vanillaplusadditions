...
public class SableAxolotlBowlBlock extends AxolotlBowlBlock implements BlockSubLevelAssemblyListener {

    public SableAxolotlBowlBlock(Properties properties) {
        super(properties);
    }

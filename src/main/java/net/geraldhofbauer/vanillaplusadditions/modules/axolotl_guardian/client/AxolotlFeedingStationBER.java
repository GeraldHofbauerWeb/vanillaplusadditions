...
public class AxolotlFeedingStationBER implements BlockEntityRenderer<AxolotlFeedingStationBlockEntity> {

    public AxolotlFeedingStationBER(BlockEntityRendererProvider.Context context) { }

    @Override
    public void render(AxolotlFeedingStationBlockEntity be, float partialTick,
        ...
        Direction facing = be.getBlockState().getValue(AxolotlFeedingStationBlock.FACING);
    ...
    @Override
    public boolean shouldRenderOffScreen(AxolotlFeedingStationBlockEntity be) {
        return false;
    }
}
